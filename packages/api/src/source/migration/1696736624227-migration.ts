...
export class Migration1696736624227 implements MigrationInterface {
  name = "Migration1696736624227";
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE \`favorites\` (\`id\` int NOT NULL AUTO_INCREMENT, \`favoriteName\` varchar(255) NOT NULL, \`domain\` varchar(255) NOT NULL, \`route\` varchar(255) NOT NULL, \`star\` tinyint NOT NULL DEFAULT 0, \`lastVisitedAt\` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP, \`createdAt\` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP, \`presetId\` int NULL, INDEX \`IDX_fed65312e52baf4e4f20c95e75\` (\`favoriteName\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`,
    );
    await queryRunner.query(
