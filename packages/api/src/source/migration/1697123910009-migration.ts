...
export class Migration1697123910009 implements MigrationInterface {
  name = "Migration1697123910009";

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE \`favorites\` (\`id\` int NOT NULL AUTO_INCREMENT, \`favoriteName\` varchar(255) CHARACTER SET "utf8" NOT NULL, \`address\` varchar(255) CHARACTER SET "utf8" NOT NULL, \`title\` varchar(255) CHARACTER SET "utf8" NOT NULL, \`description\` varchar(255) CHARACTER SET "utf8" NOT NULL, \`imgHref\` varchar(255) CHARACTER SET "utf8" NOT NULL, \`star\` tinyint NOT NULL DEFAULT 0, \`lastVisitedAt\` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP, \`createdAt\` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP, \`presetId\` int NULL, INDEX \`IDX_fed65312e52baf4e4f20c95e75\` (\`favoriteName\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`,
    );
    await queryRunner.query(
